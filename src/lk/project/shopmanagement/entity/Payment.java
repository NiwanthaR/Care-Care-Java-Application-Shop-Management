...
public class Payment {
    ...
    public Payment(String payment_id, String payment_date, int payment_cost, String vehical_no) {
    ...
    public String toString() {
        return "Payment{" + "payment_id=" + payment_id + ", payment_date=" + payment_date + ", payment_cost=" + payment_cost + ", vehical_no=" + vehical_no + '}';
    }
